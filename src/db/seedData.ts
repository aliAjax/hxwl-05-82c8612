...
export function generateSeedData() {
  ...
  const alerts: AlertItem[] = [
    ...
    },
    {
      ...
      status: "processed",
      treatment: "复测",
      treatmentNote: "换水25%后复测，亚硝酸盐仍偏高，需加强过滤",
      handler: "张师傅",
      thresholdRange: "0 - 0.5 ppm",
      description: "亚硝酸盐 0.15ppm 轻微偏高",
      recordId: "record-seed-003c",
      recordedAt: formatDateTime(daysAgo(4)),
      createdAt: formatDateTime(daysAgo(4)),
      processedAt: formatDateTime(daysAgo(3)),
    },
    {
      id: "alert-seed-005",
      tankName: "办公室繁殖缸",
      ...
      status: "processed",
      treatment: "复测",
      treatmentNote: "复测硝酸盐仍呈上升趋势，建议增加换水频率",
      handler: "张师傅",
      thresholdRange: "0 - 40 ppm",
      description: "硝酸盐 18ppm 偏高",
      recordId: "record-seed-003c",
      recordedAt: formatDateTime(daysAgo(4)),
      createdAt: formatDateTime(daysAgo(4)),
      processedAt: formatDateTime(daysAgo(3)),
    },
    {
      ...
      status: "processed",
      treatment: "复测",
      treatmentNote: "复测氨氮，虽在安全范围但持续上升需关注",
      handler: "张师傅",
      thresholdRange: "0 - 0.02 ppm",
      description: "氨氮 0.03ppm 轻微偏高",
      recordId: "record-seed-003c",
      recordedAt: formatDateTime(daysAgo(4)),
      createdAt: formatDateTime(daysAgo(4)),
      processedAt: formatDateTime(daysAgo(3)),
    },
    {
      ...
      status: "processed",
      treatment: "复测",
      treatmentNote: "pH超标复测，长期偏高需排查钙反或添加剂问题",
      handler: "王师傅",
      thresholdRange: "8.0 - 8.4",
      description: "pH 8.2 异常偏高，海缸适宜范围 7.8-8.4",
      recordId: "record-seed-006b",
      recordedAt: formatDateTime(daysAgo(5)),
      createdAt: formatDateTime(daysAgo(5)),
      processedAt: formatDateTime(daysAgo(4)),
    },
  ];
...
export const SEED_DATA_CHECK_KEY = "aquarium_seed_data_v3";
